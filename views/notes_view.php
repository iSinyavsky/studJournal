...
if(isset($this->viewMarks)):
    ...
    <?php endif;?>
        ...
        echo '<a href="'.URL.'notes/lessons/'.$this->arg[0].'.'.$this->arg[1].'">
        <div class="list-add"><i class="fa fa-chevron-left" aria-hidden="true" style="color: #fff; font-size: 20px; "></i><span>Назад к списку</span></div>
        </a>';
        echo '<br>';
        ?>
